  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: Padding(
        ...
        child: TextButton(
          style: TextButton.styleFrom(
              backgroundColor: Colors.teal, shape: const StadiumBorder()),
          onPressed: () {
            _selectTime();
          },
          child: Center(
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Text(
            'Remind me every',
            style: getRegularStyle(color: Colors.black87, fontSize: 16),
          ),
          DropdownButton(
            ...
            hint: _selected == 0
                ? Text('Select an Interval',
                    style: getBoldStyle(color: Colors.grey, fontSize: 17))
                : null,
            elevation: 4,
